...
namespace OKExSDK
{
    public class MarginApi : SdkApi
    {
        ...
        /// <returns></returns>
        public async Task<JContainer> getLedgerAsync(string instrument_id, int? from, int? to, int? limit)
        {
        ...
        /// <param name="instrument_id">币对</param>
        /// <returns></returns>
        public async Task<JObject> getAvailabilityByInstrumentId(string instrument_id)
        {
        ...
        /// <param name="orders">订单列表</param>
        /// <returns></returns>
        public async Task<JContainer> calcelOrderBatchAsync(MarginCancelOrderBatch orders)
        {
